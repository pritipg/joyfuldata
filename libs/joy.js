...
Joy.saveToURL = function(data){
	...
	//!! Added URL param
	var url = window.location.origin+window.location.pathname+"?data="+compressed+"&url="+dataURL; // append to current URL
...
modal.show = function(ui){
	...
	//!! Changed position = "above" instead of "below"
